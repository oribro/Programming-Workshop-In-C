...
/*
* The first string we compare is bigger.
*/
#define STR1_BIGGER 1

/*
* The second string we compare is bigger.
*/
#define STR2_BIGGER -1

/*
* A macro for equal strings.
*/
#define TRUE 1
...
/*
* A macro for null string pointer memory usage.
*/
#define NO_MEMORY_USAGE 0

/*
* A macro for empty string.
*/
...
/*
* A macro for assisting in calculating length of number.
*/
#define DIGIT_DIVIDER 10

/*
* A macro for end of c string.
*/
#define END_OF_C_STRING '\0'
 ...
 * RETURN VALUE:
 * @return an integral value indicating the relationship between the strings:
 * 	A zero value indicates that the strings are equal according to the custom
 * 	 comparator (3rd parameter).
 * 	A value greater than zero indicates that the first MyString is bigger
